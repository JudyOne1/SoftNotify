...
export type SoundPreset =
  | 'classic' | 'windchime' | 'water' | 'knock' | 'musicbox'
  | 'marimba' | 'kalimba' | 'dingdong' | 'bell' | 'crystal' | 'birds'
  | 'bubble' | 'zen' | 'harp' | 'sparkle' | 'flute'
...
export interface TrayPanelSnapshot {
  status: {
    kind: 'running' | 'paused' | 'focus' | 'break' | 'meeting' | 'fullscreen' | 'quiet' | 'empty'
    label: string
    detail: string
